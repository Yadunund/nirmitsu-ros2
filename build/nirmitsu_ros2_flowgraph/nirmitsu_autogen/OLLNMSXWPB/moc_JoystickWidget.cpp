/****************************************************************************
** Meta object code from reading C++ file 'JoystickWidget.hpp'
**
...
#include <memory>
#include "../../../../src/nirmitsu-ros2/nirmitsu_ros2_flowgraph/src/CustomWidgets/JoystickWidget.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'JoystickWidget.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 10), // "posUpdated"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "PosType"
QT_MOC_LITERAL(4, 35, 8) // "position"

    },
    "JoystickWidget\0posUpdated\0\0PosType\0"
    "position"
};
...
void JoystickWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->posUpdated((*reinterpret_cast< PosType(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (JoystickWidget::*)(PosType );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&JoystickWidget::posUpdated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject JoystickWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_JoystickWidget.data,
    qt_meta_data_JoystickWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void JoystickWidget::posUpdated(PosType _t1)
{
