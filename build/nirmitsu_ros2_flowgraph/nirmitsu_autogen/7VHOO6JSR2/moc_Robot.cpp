/****************************************************************************
** Meta object code from reading C++ file 'Robot.hpp'
**
...
#include <memory>
#include "../../../../src/nirmitsu-ros2/nirmitsu_ros2_flowgraph/src/robot/Robot.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Robot.hpp' doesn't include <QObject>."
...
void *Robot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "std::enable_shared_from_this<Robot>"))
        return static_cast< std::enable_shared_from_this<Robot>*>(this);
