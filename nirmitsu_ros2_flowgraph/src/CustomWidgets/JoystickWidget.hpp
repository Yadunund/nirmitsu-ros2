...
inline void JoystickWidget::paintEvent(QPaintEvent*)
{
  ...
  painter.drawImage(QRect(75+cx, 91+cy, 80, 80),
    QImage(
      "/home/dhruft/ws_nirmitsu/src/nirmitsu-ros2/nirmitsu_ros2_flowgraph/src/CustomWidgets/joystick.png"));
...
inline void JoystickWidget::mouseMoveEvent(QMouseEvent* event)
{
  ...
  if (mouseGrab)
  {
    ...
    {
      double fulldist =
        sqrt(pow((event->x()-xcenter), 2) + pow((event->y()-ycenter), 2) );
